const VIDEOS = {
  'case-study1.mp4':  '/videos/case-study1.mp4',
  'flow-1.mp4':       '/videos/flow-1.mp4',
  'flow-2.mp4':       '/videos/flow-2.mp4',
  'flow-3.mp4':       '/videos/flow-3.mp4',
  'flow-4.mp4':       '/videos/flow-4.mp4',
  'key-flow-3.mp4':   '/videos/key-flow-3.mp4',
  'key-flow-4.mp4':   '/videos/key-flow-4.mp4',
  'wfo-demo.mp4':     '/videos/wfo-demo.mp4',
  'wfo-flow-1.mp4':   '/videos/wfo-flow-1.mp4',
  'wfo-flow-2.mp4':   '/videos/wfo-flow-2.mp4',
};
...
export const projectsData = [
  {
    ...
    solutionGradient: 'linear-gradient(145deg, rgba(30,108,80,0.11) 0%, #ffffff 54%, rgba(23,79,98,0.06) 100%)',
    demoVideo: mp4('case-study1.mp4'),
    heroImage: '/step-1.webp',
    ...
    meta: {
      ...
      team: '2 Product Leaders · 2 Subject Matter Experts (SMEs) · 1 Product Designer · 4 Software Engineers',
      timeline: 'Jan 2026 – Present (In Production)',
  ...
  },
  {
    ...
    solutionGradient: 'linear-gradient(145deg, rgba(245,129,38,0.12) 0%, #ffffff 52%, rgba(23,79,98,0.06) 100%)',
    solutionAccent: '#174F62',
    heroVideo: '',
    ...
    sections: [
      {
        type: 'role',
        kicker: 'My Role',
        title: 'From discovery to shipped product.',
        intro: 'Owned the full arc: discovery, the build-vs-buy decision, end-to-end design, and usability testing, through to launch.',
        items: [
          {
            number: '01',
            title: 'Discovery',
            body: 'Interviews across Service Delivery, Integration Engineering, and the legacy FileLoader team. Competitive analysis against Salesforce, Dynamics, HubSpot, and Sugar.',
          },
          {
            number: '02',
            title: 'Build-vs-buy',
            body: 'Evaluated Flatfile across 5 dimensions. Got exec sign-off on the in-house decision before any wireframes existed.',
          },
          {
            number: '03',
            title: 'Prototyping & testing',
            body: 'Designed the File Log and 4-step import flow. Iterated through six weeks of internal usability testing with Service Delivery and Integration Engineering.',
          },
        ],
      },
      {
